...
I am a Reader in Biomedical Image Analysis at the [School of Science and Technology](https://www.citystgeorges.ac.uk/about/schools/science-technology) at [City St George's, University of London](https://www.city.ac.uk/).

I am part of the [Department of Computer Science](https://www.city.ac.uk/about/schools/mathematics-computer-science-engineering/computer-science), I teach modules in Engineering and Computer Science at undergraduate and postgraduate levels, and focus my research in computational analysis of medical and biomedical data. I am an expert in the processing, analysis, interpretation and visualisation of data, primarily related with biomedical experimentation and clinical research. I integrate my background in Electrical Engineering (MEng, MSc) and Computer Science (PhD), lab experience in a life science environment, hands-on experience with image acquisition (light, fluorescent, confocal and multiphoton microscopy) and years of analysis with a multitude of algorithmic approaches (AI/Deep Learning is just one of them) of different acquisition techniques (MRI, X-Rays, CT) to extract useful information that can be translated to relevant and real benefits for patients.

I have published more than 80 journal papers, participated and organised numerous conferences, edited several journal issues and written the book "Biomedical Image Analysis Recipes in MATLAB: For Life Scientists and Engineers".
